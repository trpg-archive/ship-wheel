            ...
            wheel: {
                ...
                onClick: () => {
						...
						wheelSound = new Audio(
							"modules/ship-wheel/assets/wheel.OGG"
						);
						...
						wheelBodyElement.style.backgroundImage = "url('modules/ship-wheel/assets/wheel.png')";
...
function startInertia() {
	...
	function animateInertia() {
		...
		wheelVelocity -= Math.sign(wheelVelocity) * inertiaDeceleration;
